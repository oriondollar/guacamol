...
def distribution_learning_benchmark_suite(train_mols: Set[str],
                                          test_mols: Set[str],
                                          test_scaffold_mols: Set[str],
                                          reconstruct: bool,
                                          version_name: str,
...
def distribution_learning_suite_v2(train_mols: Set[str], test_mols: Set[str], test_scaffold_mols: Set[str],
